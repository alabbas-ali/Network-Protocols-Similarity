...
def main():
    try:
        ...
        sys.stdout.write("\n Connrcting with : %s Src Ip : %s and Src Port : %d " % 
                          (protocol, args.src_ip, args.src_port))
        sys.stdout.write("\n Connrcting with : %s to server : %s and port : %d " % 
                          (protocol, args.dest_addr, args.dest_port))
